...
class Cargo
{
    public function Select()
    {
        ...
        foreach ($registros as $linha) {
            ...
            $car->setQtdfunc($linha['qtdefuncionario']);
            $lstCar[] = $car;
        }
    ...
    {
        $sql = "INSERT INTO cargo (nome, descricao, salario, qtdefuncionario) VALUES ('{$cargo->getNome()}','{$cargo->getDesc()}', '{$cargo->getSal()}', '{$cargo->getQtdfunc()}');";
    ...
    {
        $sql = "UPDATE cargo SET nome = ?, descricao = ?, salario = ?, qtdefuncionario = ? WHERE id = ?;";
    ...
    public function SelectNome(string $nome)
    {
        ...
        foreach ($result as $linha) {
            ...
            $cargo->setQtdfunc($linha['qtdefuncionario']);
