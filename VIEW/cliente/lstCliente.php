...
<body>
        ...
        <div class="input-field">
            <form action="../Cliente/lstCliente.php" method="GET" id="frmBuscaCliente" class="col s8">
                <div class="input-field col s8">
                    <input type="text" placeholder="informe o nome do Cliente para ser selicionado"
                        class="form-control col s10" id="txtBusca" name="busca">
    ...
    <a class="btn-floating btn-large waves-effect waves- waves-light blue"><i class="material-icons"
            onclick="JavaScript:location.href='formClt.php'">add</i></a>
