...
<head>
    ...
    <title>Detalhes de Funcionarios</title>
</head>
        ...
        <div class="container green lighten-4 black -text cols 12">
            ...
            <div class="row black-text">
                ...
                <div class="input-field col s12">
                    <h5>CPF: <?php echo $funcionario->getCPF() ?></h5>
                </div>

                <div class="input-field col s8">
                    <h5>Cargo: <?php echo $funcionario->getCargo_Id() ?></h5>
                ...
                <div class="brown lighten-3 center col s12">
                    ...
                    <button class="waves-effect waves-light btn green" type="button"
                        onclick="JavaScript:location.href='formEdtFunc.php?id=' + '<?php echo $funcionario->getId(); ?>'">Editar
                        <i class="material-icons">edit</i>
                    </button>

                    <button class="waves-effect waves-light btn red" type="button"
                        onclick="JavaScript: remover( <?php echo $funcionario->getId(); ?> )">Deletar <i
                            class="material-icons">delete</i>
                    </button>


                    <button class="waves-effect waves-light btn blue" type="button"
                        onclick="JavaScript:location.href='formFunc.php'">
